...
const List = ({ url }) => {
    ...
    const [categories, setCategories] = useState([]); // YENİ: Kategorileri tutacak state
    ...
    // YENİ: Kategorileri getirme fonksiyonu
    ...
    const handleEditClick = (food) => {
        ...
        setFormData({
            ...
            price: food.price,
            category: food.category, // Mevcut kategoriyi ayarla
            image: null,
    ...
    useEffect(() => {
        fetchList();
        fetchCategories(); // YENİ: Component yüklendiğinde kategorileri getir
    }, []);
        ...
        <div className='list add flex-col'>
            ...
            <div className="list-table">
                <div className="list-table-format title">
                    ...
                    <b>Fiyat</b>
                    <b>İşlem</b>
                    <b>Düzenle</b> {/* Yeni sütun başlığı */}
                </div>
                {list.map((item, index) => {
                    return (
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={handleUpdateSubmit} className="flex-col">
                            <div className="form-group">
                                ...
                                <img src={`${url}/images/${formData.currentImage}`} alt="Mevcut Resim" style={{ width: '100px', height: 'auto' }} />
                            ...
                            <div className="form-group">
                                ...
                                <select name="category" value={formData.category} onChange={handleChange} required>
                                    ...
                                    {/* YENİ: Kategorileri dinamik olarak render ediyoruz */}
